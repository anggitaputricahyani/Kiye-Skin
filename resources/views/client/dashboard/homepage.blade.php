      ...
      <header class="bg-white shadow fixed top-0 left-0 right-0 z-50">
        <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6 text-xl">
              ...
              <a href="/store" class="text-[#2e94a4] hover:text-[#46e6ff]">Store</a> <!-- Ubah ke tautan halaman Store -->
              <a href="/cek-kulit" class="text-[#2e94a4] hover:text-[#46e6ff] font-bold">Cek Kulit</a> <!-- Ubah ke tautan halaman Cek Kulit -->
              <a href="/login" class="px-10 py-2 bg-[#2e94a4] text-white rounded-full hover:bg-[#46e6ff]">Login</a> <!-- Ubah ke tautan halaman Login -->
          </div>
 ...
 <div class="container mx-auto p-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="relative overflow-hidden rounded-lg shadow-lg">
                <img src="{{ ('assets/img/gambar3.png') }}" alt="Image" class="w-full h-full object-cover">
 ...
 <!-- contact us -->
  ...
  <div class="flex flex-col md:flex-row items-center p-8 text-black  ">
        <div class="md:w-1/2 text-center md:text-left">
            ...
            <a href="https://wa.me/+62 88224154244" class="inline-flex items-center px-6 py-3 border border-[#2e94a4] text-[#2e94a4] rounded-lg hover:bg-[#2e94a4] hover:text-white transition duration-300">
