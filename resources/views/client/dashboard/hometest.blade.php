...
<body>
    ...
    <h1 class="text-5xl font-bold text-center whitespace-nowrap  text-[#2e94a4]">Test Kesehatan Kulit Anda</h1>
    ...
    <div class="flex justify-center pt-6"> <!-- Tambahkan div ini untuk membungkus tombol -->
        <a href="#" class="bg-[#2e94a4] rounded-md  text-white py-2 px-16 text-sm font-bold">Test Sekarang</a>
    </div>
</div>
