...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form class="form" action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-7">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <fieldset class="form-group">
                                <select class="form-select @error('skin_type') is-invalid @enderror" id="basicSelect"
                                    ...
                                    <option {{ old('skin_type') == 'Dry' ? 'selected' : '' }} value="Dry">Untuk Kulit Kering</option>
                                    <option {{ old('skin_type') == 'Oily' ? 'selected' : '' }} value="Oily">Untuk Kulit Berminyak</option>
                                    <option {{ old('skin_type') == 'Normal_Skin' ? 'selected' : '' }} value="Normal_Skin">Untuk Kulit Normal</option>
                                    <option {{ old('skin_type') == 'Dry_Oily' ? 'selected' : '' }} value="Dry_Oily">Untuk Kulit Kombinasi</option>
                                    <option {{ old('skin_type') == 'Sensitive_Skin' ? 'selected' : '' }} value="Sensitive_Skin">Untuk Kulit Sensitif</option>
                                </select>
                                @error('skin_type')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
